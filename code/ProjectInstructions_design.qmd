...
ggplot(mapping = aes(fill = trtname))+
  ...
  geom_label(data = rcbd_cld_selected,
            aes(x = trtname, y = emmean, label = .group),
            fill = "white") +
  labs(x = "Different treatment levels in different site",
       y = "Yield (kg/ha)") +
...
The letters inside the box plots indicate statistical grouping based on different ttreatments used in different site. T5 in Tifton and T5 in Oaks have the highest effect on carinata seed yield production. However, T5 in Tifton and T5 in Oaks have no statistical seed yield difference. T1 in Oaks have the lowest carinata seed yeild. However, T1, T2 and T3 in Oaks have no statistical difference in carinata seed yield production. 
